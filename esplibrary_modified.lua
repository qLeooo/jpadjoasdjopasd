...
local function checkForHumanoidRootPart()
    for _, model in pairs(Workspace:GetChildren()) do
        if model:IsA("Model") and model:FindFirstChild("HumanoidRootPart") then
            print(model.Name .. " has a HumanoidRootPart.")
        else
            print(model.Name .. " does not have a HumanoidRootPart.")
        end
    end
end

checkForHumanoidRootPart()
